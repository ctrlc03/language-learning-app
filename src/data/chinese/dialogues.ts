...
export const chineseDialogues: Dialogue[] = [
  ...
  },
  {
    ...
    lesson: 19,
    lines: [
      { speaker: 'A', text: '老板，这件衣服多少钱？', pinyin: 'Lǎobǎn, zhè jiàn yīfu duōshao qián?', translation: 'Boss, how much is this piece of clothing?' },
      { speaker: 'B', text: '20块。', pinyin: 'Èrshí kuài.', translation: '20 kuai.' },
      { speaker: 'A', text: '你能给我个折扣吗？', pinyin: 'Nǐ néng gěi wǒ ge zhékòu ma?', translation: 'Can you give me a discount?' },
      { speaker: 'B', text: '今天打8折。', pinyin: 'Jīntiān dǎ bā zhé.', translation: "Today it's 20% off.", },
      { speaker: 'A', text: '10块行吗？', pinyin: 'Shí kuài xíng ma?', translation: 'Is 10 kuai okay?' },
      { speaker: 'B', text: '不行，太便宜了。15块。', pinyin: 'Bù xíng, tài piányi le. Shíwǔ kuài.', translation: 'No way, too cheap. 15 kuai.' },
      { speaker: 'A', text: '行，没问题！', pinyin: 'Xíng, méi wèntí!', translation: 'Okay, no problem!' },
    ],
  },
  {
    id: 'dlg-l19-06',
    ...
    lesson: 19,
    lines: [
      { speaker: 'A', text: '你看上去很累。', pinyin: 'Nǐ kànshàngqu hěn lèi.', translation: 'You look very tired.' },
      { speaker: 'B', text: '是的，我今天心情不好。', pinyin: 'Shì de, wǒ jīntiān xīnqíng bù hǎo.', translation: "Yes, I'm in a bad mood today." },
      { speaker: 'A', text: '别担心，明天会更好。', pinyin: 'Bié dānxīn, míngtiān huì gèng hǎo.', translation: "Don't worry, tomorrow will be better." },
      { speaker: 'B', text: '你能告诉我怎么去公园吗？我想散步。', pinyin: 'Nǐ néng gàosu wǒ zěnme qù gōngyuán ma? Wǒ xiǎng sànbù.', translation: 'Can you tell me how to get to the park? I want to take a walk.' },
      { speaker: 'A', text: '行，跟我来！', pinyin: 'Xíng, gēn wǒ lái!', translation: 'Sure, come with me!' },
    ],
  },
  {
    id: 'dlg-l20-01',
    ...
    lesson: 20,
    lines: [
      { speaker: 'A', text: '不好意思，故宫怎么走？', pinyin: 'Bù hǎoyìsi, Gùgōng zěnme zǒu?', translation: 'Excuse me, how do I get to the Forbidden City?' },
      { speaker: 'B', text: '你坐地铁吧，坐二号线。', pinyin: 'Nǐ zuò dìtiě ba, zuò èr hào xiàn.', translation: 'Take the subway, take Line 2.' },
      { speaker: 'A', text: '要多长时间？', pinyin: 'Yào duō cháng shíjiān?', translation: 'How long does it take?' },
      { speaker: 'B', text: '大约二十分钟。', pinyin: 'Dàyuē èrshí fēnzhōng.', translation: 'About 20 minutes.' },
      { speaker: 'A', text: '好的，谢谢！还有几站？', pinyin: 'Hǎo de, xièxiè! Hái yǒu jǐ zhàn?', translation: 'Okay, thank you! How many more stops?' },
      { speaker: 'B', text: '三站。不客气！', pinyin: 'Sān zhàn. Bú kèqì!', translation: "Three stops. You're welcome!" },
    ],
  },
  {
    id: 'dlg-l20-02',
    ...
    lesson: 20,
    lines: [
      { speaker: 'A', text: '服务员！能给我菜单吗？', pinyin: 'Fúwùyuán! Néng gěi wǒ càidān ma?', translation: 'Waiter! Can I have the menu?' },
      { speaker: 'B', text: '好的，请稍等。', pinyin: 'Hǎo de, qǐng shāo děng.', translation: 'Sure, please wait a moment.' },
      { speaker: 'A', text: '这个辣吗？', pinyin: 'Zhège là ma?', translation: 'Is this spicy?' },
      { speaker: 'B', text: '有点儿辣。有不辣的吗？', pinyin: 'Yǒu diǎnr là. Yǒu bù là de ma?', translation: 'A little spicy. Do you want something non-spicy?' },
      { speaker: 'A', text: '有素食吗？我不能吃肉。', pinyin: 'Yǒu sùshí ma? Wǒ bùnéng chī ròu.', translation: "Do you have vegetarian food? I can't eat meat." },
      { speaker: 'B', text: '有的！这个很好吃。', pinyin: 'Yǒu de! Zhège hěn hǎochī.', translation: 'Yes! This one is very tasty.' },
      { speaker: 'A', text: '好，要这个。能刷卡吗？', pinyin: 'Hǎo, yào zhège. Néng shuā kǎ ma?', translation: "Okay, I'll have this. Can I pay by card?" },
      { speaker: 'B', text: '可以，也可以用微信。', pinyin: 'Kěyǐ, yě kěyǐ yòng Wēixìn.', translation: 'Yes, you can also use WeChat.' },
    ],
  },
  {
    id: 'dlg-l20-03',
    ...
    lesson: 20,
    lines: [
      { speaker: 'A', text: '你好，有空房间吗？', pinyin: 'Nǐ hǎo, yǒu kōng fángjiān ma?', translation: 'Hello, do you have any rooms available?' },
      { speaker: 'B', text: '有的。一晚多少钱？', pinyin: 'Yǒu de. Yī wǎn duōshao qián?', translation: 'Yes we do. How much is one night?' },
      { speaker: 'A', text: '标准间三百块一晚。', pinyin: 'Biāozhǔn jiān sānbǎi kuài yī wǎn.', translation: 'A standard room is 300 kuai per night.' },
      { speaker: 'B', text: '几点可以入住？', pinyin: 'Jǐ diǎn kěyǐ rùzhù?', translation: 'What time can I check in?' },
      { speaker: 'A', text: '下午两点以后。几点退房？', pinyin: 'Xiàwǔ liǎng diǎn yǐhòu. Jǐ diǎn tuìfáng?', translation: 'After 2pm. What time is check-out?' },
      { speaker: 'B', text: '早上十一点之前。可以寄存行李吗？', pinyin: 'Zǎoshang shíyī diǎn zhīqián. Kěyǐ jìcún xíngli ma?', translation: 'Before 11am. Can I store my luggage?' },
      { speaker: 'A', text: '当然可以！', pinyin: 'Dāngrán kěyǐ!', translation: 'Of course!' },
    ],
  },
  {
    ...
    lesson: 20,
    lines: [
      { speaker: 'A', text: '你好，门票多少钱？', pinyin: 'Nǐ hǎo, ménpiào duōshao qián?', translation: 'Hello, how much is the entrance ticket?' },
      { speaker: 'B', text: '成人八十，学生半价。', pinyin: 'Chéngrén bāshí, xuésheng bànjià.', translation: 'Adults 80, students half price.' },
      { speaker: 'A', text: '几点开门？几点关门？', pinyin: 'Jǐ diǎn kāimén? Jǐ diǎn guānmén?', translation: 'What time does it open? What time does it close?' },
      { speaker: 'B', text: '早上八点开，下午六点关。', pinyin: 'Zǎoshang bā diǎn kāi, xiàwǔ liù diǎn guān.', translation: 'Opens at 8am, closes at 6pm.' },
      { speaker: 'A', text: '这里能拍照吗？', pinyin: 'Zhèlǐ néng pāizhào ma?', translation: 'Can I take photos here?' },
      { speaker: 'B', text: '可以拍照，但是不能用闪光灯。', pinyin: 'Kěyǐ pāizhào, dànshì bùnéng yòng shǎnguāngdēng.', translation: "You can take photos, but you can't use a flash." },
      { speaker: 'A', text: '好的。洗手间在哪儿？', pinyin: 'Hǎo de. Xǐshǒujiān zài nǎr?', translation: 'Okay. Where is the restroom?' },
